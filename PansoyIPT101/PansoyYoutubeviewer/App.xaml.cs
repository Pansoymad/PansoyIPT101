...
using PansoyIPT101Solution.PansoyDomain.Queries;
using PansoyIPT101Solution.PansoyFramework;
using PansoyIPT101Solution.PansoyFramework.Commands;
using PansoyIPT101Solution.PansoyFramework.Queries;
using PansoyIPT101Solution.PansoyYoutubeviewer.Stores;
using PansoyIPT101Solution.PansoyYoutubeviewer.ViewModels;
using PansoyIPT101Solution.PansoyYoutubeviewer.HostBuilders;
using Microsoft.EntityFrameworkCore;

namespace PansoyIPT101Solution.PansoyYoutubeviewer
{
    /// <summary>
